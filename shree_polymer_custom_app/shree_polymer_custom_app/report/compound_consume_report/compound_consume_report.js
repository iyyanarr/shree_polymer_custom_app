...
frappe.query_reports["Compound Consume Report"] = {
	"filters": [
		{
			"fieldname":"date",
			"fieldtype":"Date",
		...
		},
		{
			...
			"options": "Workstation",
			"label":__("Press"),
			get_query:function(press_no)
			{
				return {
	                "query":"shree_polymer_custom_app.shree_polymer_custom_app.report.compound_consume_report.compound_consume_report.get_filter_pressno",
	                "filters":{
		...
		},
		{
			...
			{
				return {
	                "query":"shree_polymer_custom_app.shree_polymer_custom_app.report.compound_consume_report.compound_consume_report.get_filter_product_ref",
	                "filters":{
		...
		},
		{
			...
			get_query:function(mould_number)
			{
				return {
	                "query":"shree_polymer_custom_app.shree_polymer_custom_app.report.compound_consume_report.compound_consume_report.get_filter_mould_number",
	                "filters":{
		...
		},
		{
			...
			{
				return {
	                "query":"shree_polymer_custom_app.shree_polymer_custom_app.report.compound_consume_report.compound_consume_report.get_filter_compound_ref",
	                "filters":{
	...
	"onload": function (report) {
		...
		function get_file_attachment(email_ids) {
			...
			function download_file(email_ids) {
				...
				frappe.call({
					method: 'shree_polymer_custom_app.shree_polymer_custom_app.report.compound_consume_report.compound_consume_report.get_file_data',
					args: args,
					freeze: true,
					callback: function (r) {
